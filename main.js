...
alert('Patient data deleted successfully!')
 ...
 scroll({top:0})
  ...
  <button onclick="downloadPDF(${i})"><i class="fa-solid fa-file-pdf"></i>print patient data</button>
      ...
      <div class="row">
        ...
        <h3>Bed_No:${data_patient[i].Kardex_data.Bed_No}</h3> 
         ...
         <div class="row">
          ...
          <button style="position:relative;right:0;"      onclick=(delete_patient(${i}))><i class="fa-solid fa-trash-can"></i>delete</button>
...
if(data_patient[i].patient_name.includes(value) ||data_patient[i].MRN.includes(value)){
